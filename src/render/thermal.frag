...
// In thermal vision the scene is drawn in grey levels that equal temperature
// (see temperatureTint in src/systems/thermal.ts). This pass turns that heat map
// into the thermal image: white-hot, a light bloom around hot spots, sensor noise.
